          ...
          <div class="card">
            ...
            <div class="card-header border-0">
              <table style="width: 100%;">
                <tr>
                  <td style="text-align: left;"><h3 class="mb-0" id="judul">Pelanggan</h3></td>
            ...
            <div class="table-responsive">
              <table class="table table-flush" id="datatable-basic">
                ...
                <tbody>
                  <?php $n=1; foreach($pelanggan as $p ): ?>
                    <tr>
                    <td><?= $n++ ?></td>
                    ...
                    <td>
                      ...
                      <button id="<?= $p['pelanggan_id'] ?>" type="button" class="btn btn-danger btn-sm hapus" data-toggle="modal" data-target="#hapus"><i class="fa fa-times"></i></button>
                    </td>
                  </tr>
                  <?php endforeach ?>
                </tbody>
